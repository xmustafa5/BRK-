...
export default function About({ includeVision, ar }) {
  return (
    <section id="about" className="py-10 lg:py-0">
      <div className="container min-h-[100vh] gap-8 flex flex-col-reverse lg:flex-row lg:items-center lg:justify-center">
        ...
        <div className="flex flex-col justify-center items-center gap-4 text-center lg:items-start lg:text-start">
          ...
          <SubTitle
            title={
              ar
                ? " ترسيخ التواجد محلياً،  والانطلاق نحو الأسواق العالمية"
                : "Establishing presence locally, and launch towards markets globalism"
            }
          />
          <Button title={ar ? "استكشف المزيد" : "Explore More"} />
        </div>
      </div>
    </section>
  );
